...
<?php
     ...
     $sorgu = $con->query("SELECT * FROM members WHERE username='".$_SESSION["username"]."' ");
            ...
            <div class="card">
              ...
              <div class="card-body">
               <form action="create_news.php" method="post" enctype="multipart/form-data">
                   ...
                   <input type="hidden" id="author" name="author" value="<?php echo $cikti["id"] ?>" />
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Açıklama</label>
                      <textarea  class="form-control" cols="30" rows="10" name="description" placeholder="Açıklama" required></textarea>
                  </div>
